      ...
      var pathname = url.parse(_url, true).pathname;
        // if(pathname === myInfo){
          db.query(`SELECT * FROM userinfo where userid=?`,[userLogin], function(error,userinfo){
            ...
            db.query(`SELECT * FROM profile where userid=?`,[userLogin], function(error2,userprofile){
              if(error2){
                throw error2;
                console.log(profilePic);
              }
              var profilepic = userprofile[0].profilepic;
                                                ...
                                                // if(pathname === myInfo){
                                                  db.query(`SELECT * FROM userinfo where userid=?`,[userLogin], function(error,userinfo){
                                                    if(error){
                                                      ...
                                                      var password = userinfo[0].password; //description
                                                      var list = template.list(userinfo);
                                                      var html = template.HTML(`<a class="nav-link active" href="/editUsername">EDIT</a>
                                                      <br>&nbsp&nbsp&nbsp이름 <br>&nbsp&nbsp&nbsp${(userinfo[0].username)}`, list,
                                                        ``,
                                                        ` <form action="editPasswordChk" method="post" data-parsley-validate>
                                                                    ...
                                                                    // if(pathname === myInfo){
                                                                      db.query(`SELECT * FROM userinfo where userid=?`,[userLogin], function(error,userinfo){
                                                                        if(error){
                                                                          ...
                                                                          <br>&nbsp&nbsp&nbsp이름 <br>&nbsp&nbsp&nbsp${(userinfo[0].username)}`, list,
                                                                            ``,
                                                                            ` <form action="changePasswordPro" method="post" class="form-group"
                                                                            data-parsley-validate><br>
